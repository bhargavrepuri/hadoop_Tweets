...
public class SeminarEnrollment {
	...
	extends Mapper<Object, Text, Text, IntWritable>{
		...
		public void map(Object key, Text value, Context context
			...
			String courseName = rowData[8];
			if(!courseName.contains("Seminar"))
			{
				return;
			}
			String o = Sem+"_Seminar";
			word.set(o);
	...
	public static void main(String args[]) throws Exception
	{
		...
		Job job = Job.getInstance(conf, "Seminar enrollment");
		job.setJarByClass(SeminarEnrollment.class);
