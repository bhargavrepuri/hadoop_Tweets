...
public class BuildingExamsHosted {
	...
	extends Mapper<Object, Text, Text, IntWritable>{
		...
		public void map(Object key, Text value, Context context
			...
			String dept = rowData[4].trim();
			String building = rowData[5].split(" ")[0];
			String Sem = rowData[3].trim();
			String k = Sem+"_"+building;
			Integer enrolled = Integer.valueOf(rowData[12].trim());				
			word.set(k);				
	...
	public static void main(String args[]) throws Exception
	{
		...
		Job job = Job.getInstance(conf, "exams building has hosted");
		job.setJarByClass(BuildingExamsHosted.class);
