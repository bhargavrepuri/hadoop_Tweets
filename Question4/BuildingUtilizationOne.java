...
public class BuildingUtilizationOne{
	...
	extends Reducer<Text,FloatWritable,Text,FloatWritable> {
		...
		public void reduce(Text key, Iterable<FloatWritable> values,
			...
			FloatWritable val = new FloatWritable(1);
			result = values.iterator().next();
			if(result.get()<val.get())
			{
				return;
			}
	...
	public static void main(String args[]) throws Exception
	{
		...
		Job job = Job.getInstance(conf, "building utilization");
		job.setJarByClass(BuildingUtilizationOne.class);
