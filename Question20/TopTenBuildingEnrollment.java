...
public class TopTenBuildingEnrollment {
...
//			String o = Sem+"_"+course;
 ...
 public static class TopTenReducer
	...
	public static void main(String args[]) throws Exception
	{
		...
		job.setJarByClass(TopTenBuildingEnrollment.class);
	...
	//	System.exit(job.waitForCompletion(true) ? 0 : 1);
	    ...
	    Configuration conf2 = new Configuration();
		 Job job2 = Job.getInstance(conf2, "top ten building used by students using it");
		 job2.setJarByClass(TopTenBuildingEnrollment.class);
